    ...
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center">
        ...
        <button
          ...
          className={`px-8 py-2 mb-4 bg-blue-500 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'}`}
        >
          {isSubmitting ? (
