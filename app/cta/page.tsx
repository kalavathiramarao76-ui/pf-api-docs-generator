      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center">
        <div className="relative mb-4">
          <input
            ...
            className={`w-full p-4 pl-10 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-2 border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${formErrors.email.isValid ? '' : 'border-red-500'}`}
          />
