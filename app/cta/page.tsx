      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center">
        <div className="relative mb-4">
          <input
            ...
            className="w-full p-4 pl-10 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-600"
          />
          {formErrors.email.message && (
            <div className="absolute top-0 right-0 p-2 text-red-500">{formErrors.email.message}</div>
          )}
        </div>
        <button
          type="submit"
