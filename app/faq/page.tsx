...
export default function FaqPage() {
  ...
  return (
    <div>
      ...
      <p>Learn how to get started with AutoGenerate API Documentation and start generating high-quality API documentation for your software development projects.</p>
    </div>
  );
}